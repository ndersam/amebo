...
/**
 * Mustache transformer implementation.
 * Original FreeMarker implementation by
 *
 * @author Daniel DeGroff https://github.com/inversoft/prime-transformer
 */
public class MustacheTransformer implements Transformer {
     ...
     */
    public MustacheTransformer(Map<String, Template> templates) {
     ...
     *                  for a specific tag.
     */
    public MustacheTransformer(Map<String, Template> templates, boolean strict) {
    ...
    private String executeTemplate(Template template, TagNode tagNode, String body) throws TransformException {
        ...
        for (Map.Entry<String, String> entry : tagNode.attributes.entrySet()) {
        ...
        try {
            ...
            throw new TransformException("Mustache processing failed for template [" + template.toString() + "]\n\t Data model [" + data + "]", e);
        }
    }
