...
package com.amebo.core.converter.domain;
...
public class Document extends BaseTagNode {
    ...
    public boolean equals(Object o) {
        ...
        return equals(attributeOffsets, document.attributeOffsets) &&
                equals(children, document.children) &&
                equals(offsets, document.offsets) &&
    ...
    @Override
    public int hashCode() {
        int result = hash(super.hashCode(), attributeOffsets, children, offsets);
    ...
    public String toString() {
        return "Document{" +
                ...
                "]" +
                ", offsets=[" +
                offsets.stream().map(o -> o.first + ":" + o.second).collect(Collectors.joining(", ")) +
                "]" +
                ", attributeOffsets=[" +
                attributeOffsets.stream().map(o -> o.first + ":" + o.second).collect(Collectors.joining(", ")) +
                "]" +
                "}";
    }
