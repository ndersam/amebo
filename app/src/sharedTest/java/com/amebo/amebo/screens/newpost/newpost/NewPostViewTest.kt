...
class NewPostViewTest {
    ...
    fun before() {
        ...
        launchTestFragmentInTestActivity(R.layout.new_post_screen) { fragment, view ->
            ...
            this.view = NewPostView(fragment, pref, binding, topic, listener)
        }
    }

    @Test
    fun onCreateView_initializedAppropriately() {
    ...
    @Test
    fun quotePost_onFormError_viewUpdatesAppropriately() {
    ...
    @Test
    fun quotePost_onFormLoading_viewUpdatesAppropriately() {
